...
app.post('/cartoes', async (req, res) => {
  ...
  // Log para depuração
  console.log('Dados recebidos no backend:', { nome, id_conta, metodos_pagamento, limite });
  ...
  try {
    ...
    console.error('Erro ao criar cartão:', error); // Log detalhado do erro
